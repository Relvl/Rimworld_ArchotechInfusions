...
public class IntegrityStatWorker : StatWorker
{
    ...
    {
        return req.HasThing && req.Thing.HasComp<InstructionsComps>();
    }
    ...
    public override IEnumerable<Dialog_InfoCard.Hyperlink> GetInfoCardHyperlinks(StatRequest statRequest)
    {
        ...
        yield return new Dialog_InfoCard.Hyperlink(ArchInfExternalUrlDefOf.ArchInf_ExternalUrl_Integrity_Wiki);
    }
}