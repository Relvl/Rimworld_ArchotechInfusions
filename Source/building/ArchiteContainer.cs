...
public class ArchiteContainer : AGridBuilding
{
    ...
    private ArchiteContainerProps.Comp _comp;

    private ArchiteContainerProps.ItemData _maxUnloadableContainer;
    private ArchiteContainerProps.ItemData _minContainer;

    private float _stored;

    private ArchiteContainerProps.Comp Comp => _comp ??= GetComp<ArchiteContainerProps.Comp>();
