...
public class Transceiver : AGridBuildingStateful
{
    ...
    private bool _mute;
    private TransceiverProps.Comp _transceiver;
    private TransceiverProps.Comp Comp => _transceiver ??= GetComp<TransceiverProps.Comp>();
    ...
    protected override void OnStateComplete()
    {
        ...
        switch (State)
        {
            ...
            case StateReceive:
                ...
                foreach (var decoder in Grid.Get<Decoder>())
                {
    ...
    protected virtual AcceptanceReport TryRun(bool silent = false)
    {
        ...
        var keyGenerators = Grid.Get<KeyGenerator>();
